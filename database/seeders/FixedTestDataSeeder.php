...
class FixedTestDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Create domains for fixed tenants
        Domain::create([
            'domain' => 'tenant-one.byteforge.se',
        ...
        // Create memberships
        // User with multiple tenants -> owns tenant_one and tenant_two
        Membership::create([
        ...
        // User with single tenant -> owns tenant_three
        Membership::create([
