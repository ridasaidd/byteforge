...
if (!i18n.isInitialized) {
  i18n
    ...
    .init({
      resources: {
        en: { common: enCommon, auth: enAuth, dashboard: enDashboard, settings: enSettings, billing: enBilling, booking: enBooking, tenants: enTenants, users: enUsers, pages: enPages, public: enPublic, access: enAccess, navigations: enNavigations, themes: enThemes, media: enMedia, analytics: enAnalytics, activity: enActivity },
        sv: { common: svCommon, auth: svAuth, dashboard: svDashboard, settings: svSettings, billing: svBilling, booking: svBooking, tenants: svTenants, users: svUsers, pages: svPages, public: svPublic, access: svAccess, navigations: svNavigations, themes: svThemes, media: svMedia, analytics: svAnalytics, activity: svActivity },
        ar: { common: arCommon, auth: arAuth, dashboard: arDashboard, settings: arSettings, billing: arBilling, booking: arBooking, tenants: arTenants, users: arUsers, pages: arPages, public: arPublic, access: arAccess, navigations: arNavigations, themes: arThemes, media: arMedia, analytics: arAnalytics, activity: arActivity },
      },
      fallbackLng: 'en',
      supportedLngs: SUPPORTED_LOCALES as unknown as string[],
      nonExplicitSupportedLngs: true,
      defaultNS: 'common',
      ns: ['common', 'auth', 'dashboard', 'settings', 'billing', 'booking', 'tenants', 'users', 'pages', 'public', 'access', 'navigations', 'themes', 'media', 'analytics', 'activity'],
      interpolation: {
        escapeValue: false,
      },
      detection: {
