...
export const marginControl = {
  ...
  render: (props: any) => {
    ...
    return <ResponsiveSpacingControl field={{ label: 'Margin' }} value={value} onChange={onChange} />;
  },
};
...
export const paddingControl = {
  ...
  render: (props: any) => {
    const { value, onChange } = props;
    return <ResponsiveSpacingControl field={{ label: 'Padding' }} value={value} onChange={onChange} />;
  },
};
...
export const widthControl = {
  ...
  render: (props: any) => {
    const { value, onChange } = props;
    return <ResponsiveWidthControl field={{ label: 'Width' }} value={value} onChange={onChange} />;
  },
};
...
export const displayControl = {
  ...
  render: (props: any) => {
    const { value, onChange } = props;
    return <ResponsiveDisplayControl field={{ label: 'Display' }} value={value || { mobile: 'block' }} onChange={onChange} />;
  },
};
...
export const fontSizeControl = {
  ...
  render: (props: any) => {
    const { value, onChange } = props;
    return <ResponsiveFontSizeControl field={{ label: 'Font Size' }} value={value} onChange={onChange} />;
  },
};
