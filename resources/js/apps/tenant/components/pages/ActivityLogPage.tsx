...
import type { ActivityLog } from '@/shared/services/api/types';
import { tenantActivity } from '@/shared/services/api/tenantActivity';
...
export function ActivityLogPage() {
  ...
  const activity = useQuery({
    queryKey: ['tenant-activity', page],
    queryFn: () => tenantActivity.list({ page, per_page: 15 }),
  });
