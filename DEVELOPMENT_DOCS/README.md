...
- Orchestrator/executor handoff rules: [AI_ORCHESTRATOR_EXECUTOR_WORKFLOW.md](AI_ORCHESTRATOR_EXECUTOR_WORKFLOW.md), [execution/EXECUTION_PACKET_TEMPLATE.md](execution/EXECUTION_PACKET_TEMPLATE.md)
