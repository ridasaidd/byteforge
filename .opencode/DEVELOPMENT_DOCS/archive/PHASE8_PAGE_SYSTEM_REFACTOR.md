...
```
Phase 8.1: Clean Up Page Creation Wizard
├── [x] Remove "Import from Saved" option
├── [x] Fix template listing from active theme
└── [x] Consolidate page_type/is_homepage logic

Phase 8.2: Update Edit Page Modal
├── [x] Add is_homepage checkbox to General tab
├── [x] Remove Layout & Parts tab
└── [x] Keep SEO tab

Phase 8.3: Inject Header/Footer in Page Editor
├── [x] Fetch active theme parts on page load
├── [x] Render header/footer as static context
└── [x] Add link to Theme Customizer

Phase 8.4: Inject Theme CSS in Page Editor
├── [x] Add useEditorCssLoader hook
└── [x] Wrap with ThemeProvider context

Phase 8.5: Unify Central and Tenant Page Creation
├── [x] Update tenant PagesPage
└── [x] Use shared PageCreationWizard

Phase 8.6: Clean Up Backend (Complete)
├── [x] Decided on layout/parts fields (Removed)
...
|------|------|-------------|--------|
| 8.1.1 | PageCreationWizard.tsx | Remove "Import from Saved" card and state | ✅ Done |
| 8.1.2 | PageCreationWizard.tsx | Add is_homepage auto-set when page_type='home' | ✅ Done |
| 8.1.3 | PagesPage.tsx (central) | Verify templates query works | ✅ Done |
| 8.1.4 | - | Test template selection creates page with content | ✅ Done |

### Phase 8.2 Tasks

| Task | File | Description | Status |
|------|------|-------------|--------|
| 8.2.1 | PagesPage.tsx (central) | Add is_homepage checkbox to edit modal | ✅ Done |
| 8.2.2 | PagesPage.tsx (central) | Remove Layout & Parts tab from getFormTabs() | ✅ Done |
| 8.2.3 | pageSchema | Remove layout_id, header_id, footer_id validation | ✅ Done |
| 8.2.4 | - | Test editing page without layout/parts | ✅ Done |

### Phase 8.3 Tasks

| Task | File | Description | Status |
|------|------|-------------|--------|
| 8.3.1 | PageEditorPage.tsx | Fetch active theme and its parts | ✅ Done |
| 8.3.2 | PageEditorPage.tsx | Render header above Puck (static) | ✅ Done |
| 8.3.3 | PageEditorPage.tsx | Render footer below Puck (static) | ✅ Done |
| 8.3.4 | PageEditorPage.tsx | Style as read-only context | ✅ Done |
| 8.3.5 | - | Add "Edit in Theme Customizer" link | ✅ Done |

### Phase 8.4 Tasks

| Task | File | Description | Status |
|------|------|-------------|--------|
| 8.4.1 | PageEditorPage.tsx | Import and use useEditorCssLoader | ✅ Done |
| 8.4.2 | PageEditorPage.tsx | Wrap with ThemeProvider | ✅ Done |
| 8.4.3 | - | Test CSS rendering matches storefront | ✅ Done |

### Phase 8.5 Tasks

| Task | File | Description | Status |
|------|------|-------------|--------|
| 8.5.1 | PagesPage.tsx (tenant) | Import PageCreationWizard | ✅ Done |
| 8.5.2 | PagesPage.tsx (tenant) | Fetch templates for tenant | ✅ Done |
| 8.5.3 | PagesPage.tsx (tenant) | Replace FormModal with wizard | ✅ Done |
| 8.5.4 | - | Test tenant page creation with templates | ✅ Done |
